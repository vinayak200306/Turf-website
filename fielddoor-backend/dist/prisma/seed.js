...
async function main() {
    ...
    const adminUser = await prisma.user.upsert({
        ...
        update: { role: client_1.Role.ADMIN, name: "Field Door Admin", countryCode: "+91" },
        create: {
            phone: "+911111111111",
            countryCode: "+91",
    ...
    const ownerUser = await prisma.user.upsert({
        ...
        update: { role: client_1.Role.VENUE_OWNER, name: "Venue Ops Lead" },
        create: {
            phone: "+919999999999",
            countryCode: "+91",
            role: client_1.Role.VENUE_OWNER,
            name: "Venue Ops Lead",
    ...
    const sportByName = Object.fromEntries((await prisma.sport.findMany()).map((sport) => [sport.name, sport]));
    const venues = [
        {
            name: "Galaxy Zone",
    ...
    logger_1.default.info(`Seed complete. Admin: ${adminUser.phone}`);
}
main()
    .finally(async () => {
